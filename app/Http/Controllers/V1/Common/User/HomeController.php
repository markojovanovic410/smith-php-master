...
class HomeController extends Controller
{
	...
	public function index(Request $request) {
        ...
        \Log::info("User Menu City------------".$city_id);
        ...
        \Log::info("User MEnu Service List----------");
        \Log::info($menus->services);
        \Log::info("---------------");
    ...
    public function update_fcm_token(Request $request){
        ...
        return Helper::getResponse(['message' => 'FCM Token Updated']);
    }
	...
	public function carddetail(Request $request)
	{
        ...
        $cards = UserPaystackCard::where('user_id',Auth::guard('user')->user()->id)->where('company_id',Auth::guard('user')->user()->company_id)->get();
    ...
    public function news_get(Request $request){

    $data = News::where('user_type', 'USER')->orWhere('user_type', 'BOTH')->orderby('created_at', 'desc')->paginate(15);
    return Helper::getResponse(['status' => 200, 'message' => 'success', 'data' => $data]);
