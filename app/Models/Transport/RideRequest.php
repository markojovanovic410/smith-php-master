...
class RideRequest extends BaseModel
{
	...
	protected $hidden = [
     	'company_id', 'created_by', 'modified_type', 'modified_by', 'deleted_type', 'deleted_by', 'updated_at', 'deleted_at', 'twilio_voice_token'
     ];
    ...
    protected $appends = ['created_time','assigned_time', 'schedule_time', 'started_time', 'finished_time', 'twilio_token'];
    ...
    {
        return $this->hasOne('App\Models\Transport\RideRequestPaymentRefund', 'ride_request_id');
    }

    public function getTwilioTokenAttribute()
    {
        return json_decode($this->twilio_voice_token);
    }
