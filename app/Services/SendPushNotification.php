    ...
    */
    ...
    public function sendPushToUser($user_id, $topic, $push_message, $title = null, $data = null){
        ...
        try{
            ...
            if($user->fcm_token != ""){
                $this->sendPushNotification_live($push_message, $title, $data, $user);
            }
    ...
    public function sendPushNotification_live($push_message, $title, $data, $user){
        ...
        $response = \Httpful\Request::post($url)
                    ...
                    ->body(json_encode($fields))
                     ->addHeaders($headers)
                     ->send();
        \Log::info("FMC_ notification response-----");
        \Log::info($response);
        return $response;
    }
