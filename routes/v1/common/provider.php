...
$router->group(['middleware' => 'auth:provider'], function($app) {
    ...
    $app->post('/fcm_token', 'V1\Common\Provider\HomeController@update_fcm_token');
    ...
    // Reward
    $app->get('/rewards', 'V1\Common\Provider\RewardController@get');
    $app->get('/rewards/redeem/{id}', 'V1\Common\Provider\RewardController@redeem');

    // news
    $app->get('/news', 'V1\Common\Provider\HomeController@news_get');
});
