...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->get('/all-countries', 'V1\Common\Admin\Resource\CompanyCountriesController@all_countries');
    $app->get('/all-countries/cities/{country_id}', 'V1\Common\Admin\Resource\CompanyCountriesController@countries_all_cities');

    //Cities
    $app->post('/reward', 'V1\Common\Admin\Resource\RewardController@post');
    $app->get('/rewards/{id}', 'V1\Common\Admin\Resource\RewardController@get');
    $app->get('/rewards', 'V1\Common\Admin\Resource\RewardController@get');
    $app->delete('/reward/delete/{id}', 'V1\Common\Admin\Resource\RewardController@delete');

    // News
    $app->post('/news', 'V1\Common\Admin\Resource\NewsController@post');
    $app->get('/news/{id}', 'V1\Common\Admin\Resource\NewsController@get');
    $app->get('/news', 'V1\Common\Admin\Resource\NewsController@get');
    $app->delete('/news/delete/{id}', 'V1\Common\Admin\Resource\NewsController@delete');

    //////////////////Driver Data Start

    //Driver data
    $app->get('/driver-data', 'V1\Common\Admin\Resource\DriverDataController@index');

    //Cities
    $app->get('/driver-data/cities', 'V1\Common\Admin\Resource\DriverDataController@cities');
    $app->post('/driver-data/cities', 'V1\Common\Admin\Resource\DriverDataController@cities');
    $app->delete('/driver-data/cities/{id}', 'V1\Common\Admin\Resource\DriverDataController@cities_delete');
    $app->get('/driver-data/cities/{id}', 'V1\Common\Admin\Resource\DriverDataController@city_get');

    //Type fo cars
    $app->get('/driver-data/type-of-cars', 'V1\Common\Admin\Resource\DriverDataController@type_of_cars');
    $app->post('/driver-data/type-of-cars', 'V1\Common\Admin\Resource\DriverDataController@type_of_cars');
    $app->delete('/driver-data/type-of-cars/{id}', 'V1\Common\Admin\Resource\DriverDataController@type_of_cars_delete');
    $app->get('/driver-data/type-of-cars/{id}', 'V1\Common\Admin\Resource\DriverDataController@type_of_cars_get');

    //////////////////Driver data end

    $app->get('/test-notification', 'V1\Common\Admin\Auth\AdminController@test_notification');
    ...
    //Driver Promotions
    $app->get('/driver-promotion', 'V1\Common\Admin\Resource\PromocodeController@driver_index');
    $app->post('/driver-promotion', 'V1\Common\Admin\Resource\PromocodeController@driver_store');
    $app->get('/driver-promotion/{id}', 'V1\Common\Admin\Resource\PromocodeController@driver_show');
    $app->patch('/driver-promotion/{id}', 'V1\Common\Admin\Resource\PromocodeController@driver_update');
    $app->delete('/driver-promotion/{id}', 'V1\Common\Admin\Resource\PromocodeController@driver_destroy');
    ...
    //cmsfaq
    $app->get('/cmsfaq', 'V1\Common\Admin\Resource\CmsController@faqIndex');
    $app->post('/cmsfaq', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CmsController@faqStore']);
    $app->delete('/cmsfaq/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CmsController@faqDestroy']);
    $app->get('/cmsfaq/{id}', 'V1\Common\Admin\Resource\CmsController@faqShow');

    //cms how it works
    $app->get('/cmshowitworks', 'V1\Common\Admin\Resource\CmsController@cmshowitworksIndex');
    $app->post('/cmshowitworks', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CmsController@cmshowitworksStore']);
    $app->delete('/cmshowitworks/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CmsController@cmshowitworksDestroy']);
    $app->get('/cmshowitworks/{id}', 'V1\Common\Admin\Resource\CmsController@cmshowitworksShow');

    //cms home news
    $app->get('/cmshomenews', 'V1\Common\Admin\Resource\CmsController@cmshomenewsIndex');
    $app->post('/cmshomenews', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CmsController@cmshomenewsStore']);
    $app->delete('/cmshomenews/{id}', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CmsController@cmshomenewsDestroy']);
    $app->get('/cmshomenews/{id}', 'V1\Common\Admin\Resource\CmsController@cmshomenewsShow');
