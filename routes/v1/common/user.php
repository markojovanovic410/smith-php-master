...
$router->group(['middleware' => 'auth:user'], function($app) {
    ...
    $app->post('/fcm_token', 'V1\Common\User\HomeController@update_fcm_token');
    ...
    // Reward
    $app->get('/rewards', 'V1\Common\User\RewardController@get');
    $app->get('/rewards/redeem/{id}', 'V1\Common\User\RewardController@redeem');

    // news
    $app->get('/news', 'V1\Common\User\HomeController@news_get');
